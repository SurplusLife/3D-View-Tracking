...
public:
	...
	HRESULT Drawp(BYTE* pImage, unsigned long cbImage, Point3f *view, int hnum);
...
private:
	...
	ID2D1SolidColorBrush*   grenc; //녹색
	ID2D1SolidColorBrush*   acuc; //청록색
	ID2D1SolidColorBrush*   yellc; //노란색
	ID2D1SolidColorBrush*   purpc; //보라색
