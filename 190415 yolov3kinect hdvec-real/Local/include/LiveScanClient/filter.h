...
void filtert(std::vector<Point3f> &vertices, std::vector<RGB> &colors, std::vector<Point2i> &cpoint, int k = 10, float maxDist = 0.01); //수정

void filter(std::vector<Point3f> &vertices, std::vector<RGB> &colors, int k = 10, float maxDist = 0.01); //원본