...
void filtert(std::vector<Point3f> &vertices, std::vector<RGB> &colors, std::vector<Point2i> &cpoint, int k, float maxDist)
{
	if (k <= 0 || maxDist <= 0)
		return;
